...
test("page uses repositories while dashboards and People remain mock in hybrid mode", () => {
  ...
  assert.match(registry, /moduleName === "hotel-settings" \|\| moduleName === "organization-management" \|\| moduleName === "position-management"/);
});
