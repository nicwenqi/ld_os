...
test("Hotel Settings Center covers synthetic identity, branding, rules, and initialization", async () => {
  const page = await read("../app/settings/hotel/page.tsx");
  for (const token of [
    "酒店设置中心", "基本信息", "酒店标识", "业务规则", "初始化进度", "正式中文名称",
    "正式英文名称", "显示简称", "酒店代码", "品牌", "城市", "国家 / 地区", "时区",
    "默认语言", "新员工定义", "试用期字段含义", "员工状态来源", "CTC", "GTC",
    "保存基本信息", "保存业务规则", "仅支持 PNG、JPEG 或 WebP", "30 天",
